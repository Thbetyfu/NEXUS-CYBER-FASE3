...
| Folder | Produk | Peran |
| --- | --- | --- |
| [`nexus-gaas-web/`](./nexus-gaas-web/) | Channel Portal (Next.js `:3003`) | Pintu jual lab + kandidat Root Directory Vercel jika Connect Git FASE3 (**discouraged**). Generate Node: `CHANNEL_STARTER_URL=http://127.0.0.1:3010`. Preview publik: `/starter`. |
