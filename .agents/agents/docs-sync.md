...
**Product model:** Channel Starter (entry) + GaaS Edge Antibody Cowork — [`docs/PRODUCT_MODEL.md`](../../nexus-core/docs/PRODUCT_MODEL.md). Keputusan bisnis: [`docs/DECISIONS_OPEN.md`](../../nexus-core/docs/DECISIONS_OPEN.md) — **tanya pemilik** jika tidak ada di dokumen.

**Core responsibilities:**
1. After behavior change: `nexus-core/CHANGELOG.md` + every **Hidup** file in `nexus-core/docs/README.md`.
