...
| Unggah | Shell berkedok gambar, EXIF | AVSE + magic bytes; handler publik `/api/upload` | Nyata |
| Vault lab | Brute-force password hadiah | `/api/unlock-reward`, autoban 5x | Nyata |
