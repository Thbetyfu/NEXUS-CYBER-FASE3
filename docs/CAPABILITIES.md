...
| SOC / Operator GaaS Console | Kanal, Job L0/L1, artefak, ban, CLI, telemetri | `:8081` + cookie · `:3001` | Nyata; internal; GaaS-only UI |
...
- **Command Center / Operator GaaS Console:** kokpit operator (kanal, Job L0/L1, artefak); bukan deliverable ke klien; tanpa War Room/MTD/license UI
