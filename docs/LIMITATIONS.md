...
19. **Kredit lab** — ledger file di Channel Portal; keran hanya `NEXUS_LEDGER_MODE=lab`. **Bukan** e-money, **bukan** Midtrans, **bukan** jual Job 200 Kr dari portal. CLI `channel-starter` generate **tanpa** debit. Halaman `/order` tidak memakai `opacity: 0` Framer Motion.
---
