...
*   **Inference Full Local**: Reflex Layer (`nex-ai-reflex`) dan Reasoning Layer (`nex-ai-protect`) berjalan lokal via Ollama di kluster/server kita. Seluruh inferensi berlangsung di infrastruktur sendiri tanpa vendor AI cloud, mempertahankan margin kotor hingga **67.6%** pada Lean Stage.
