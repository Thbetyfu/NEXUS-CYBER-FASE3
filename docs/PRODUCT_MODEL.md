...
| Paket | Isi | Ilustrasi |
| --- | --- | --- |
| **Starter** | Form lengkap → template Nexcent (4 palet) → subdomain lab + `vercel.json` + header tepi Caddy. Preview lab: `/preview/{slug}` di mesin yang `serve`; contoh git `examples/contoh-nexcent` | ~Rp 0–29rb/bulan |
