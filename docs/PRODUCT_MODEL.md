...
| Paket | Isi | Ilustrasi |
| --- | --- | --- |
| **Starter** | Form lengkap → template Nexcent (4 palet) → subdomain lab + publish Vercel per folder (jika token/login; bukan git Nexus) + header tepi Caddy. Preview lab: `/preview/{slug}`; contoh git `sites/contoh-nexcent` | ~Rp 0–29rb/bulan |
