...
- **Dual-Brain AI**: [VERIFIED 🟡] Memberikan akurasi tinggi. Risiko: Latensi dari "Reasoning Layer" (NEX-AI). QA merekomendasikan mekanisme asynchronous processing untuk layer ini agar tidak memblock trafik utama.
...
| **AI Failover** | Jika model NEX-AI down, trafik mencurigakan mungkin tidak teranalisis. | Fallback otomatis ke "Hard-coded Security Rules" dan logging kritis untuk audit manual. |
