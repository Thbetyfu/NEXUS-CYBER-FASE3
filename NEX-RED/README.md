...
It is **not** Shannon and **not** Strix. v5 is Jalan B **Fase 0–3 irisan**: SAST, job async, pemeriksaan HTTP tanpa sesi, allow-list host. Bukan proof-by-exploitation.
...
```bash
cd NEX-RED
python -m unittest tests.test_nexred tests.test_live_http tests.test_benchmark
