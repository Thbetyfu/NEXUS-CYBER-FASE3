...
- **Kredit:** `nexus-gaas-web` `npm test` (`kredit-ledger.test.ts`) — keran, fail-closed, refund, **dua session id saldo terpisah**, migrasi tamu→akun. Bukan Midtrans. Top-up QRIS/VA+approve belum ada tes (belum dikode).
