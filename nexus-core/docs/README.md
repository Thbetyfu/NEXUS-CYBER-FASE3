...
| [GIT_WORKFLOW.md](./GIT_WORKFLOW.md) / [REPO_LAYOUT.md](./REPO_LAYOUT.md) / [NEX_AI_RUNTIME.md](./NEX_AI_RUNTIME.md) | Dua folder in-repo (`nexus-core/` + `nexus-gaas-web/`), clone tanpa submodule, AI |
