...
19. **Model tulis Channel Portal** — langkah 2 = Ollama `127.0.0.1:11434` + health `GET /api/local-llm/health`. **Bukan** cerita→JSON. **Bukan** preview LLM. **Jangan** tunnel `:11434`. NEX-AI protect/reflex tetap WAF, bukan copy situs.
