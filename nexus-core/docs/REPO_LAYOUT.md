...
Channel Portal (Next.js `:3003`). Generate site tetap ke Channel Starter lokal **`:3010`** (`CHANNEL_STARTER_URL=http://127.0.0.1:3010`). Pohon SaaS lama (Prisma/Midtrans) di cabang `archive/legacy-saas` pada repo GaaS.
