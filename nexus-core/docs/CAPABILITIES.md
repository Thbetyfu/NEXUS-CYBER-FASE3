...
| Channel Portal / multi-tenant legacy | **Portal v0.1** | `nexus-gaas-web/` — login/daftar/tamu; **Kredit** Starter 20 Kr per identitas (keran lab). Top-up QRIS/VA+bukti+approve **belum dikode**. Bukan PSP pihak ketiga; bukan F-10 |
