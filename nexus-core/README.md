...
Mesin: WAF Go (`:8080`) + wasit NEX-RED (defense delta + antibody loop + **Job Cowork**) + Command Center operator (`:8081`) + **Channel Portal** ([`../nexus-gaas-web/`](../nexus-gaas-web/) `:3003`).
...
| --- | --- | --- | --- |
| **nexus-core** | `D:\NEXUS\nexus-core\` | [NEXUS-CYBER-FASE3](https://github.com/Thbetyfu/NEXUS-CYBER-FASE3) | WAF, NEX-RED, dasbor operator, `channel-starter/`, lab |
| **nexus-gaas-web** | `D:\NEXUS\nexus-gaas-web\` (lab) · opsional `D:\nexus-gaas-web` | [NEXUS-CYBER-WEBISTE-GaaS](https://github.com/Thbetyfu/NEXUS-CYBER-WEBISTE-GaaS) | Channel Portal → **Vercel** (bukan Connect warung) |

Portal lab: [`../nexus-gaas-web/`](../nexus-gaas-web/). Tata letak: [`docs/REPO_LAYOUT.md`](./docs/REPO_LAYOUT.md).
