...
| Pagar tipis | `cli.py upsell enable --slug … --tier tepi` — **tambah** host ke peta lab (portfolio tetap; Host/`origin` junk ditolak) | Setiap generate 20 Kr; debit 20 Kr; Loop; mass CNAME |
